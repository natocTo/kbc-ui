...
images =
  green: require '@keboola/indigo-ui/lib/img/status-green.svg'
  grey: require '@keboola/indigo-ui/lib/img/status-grey.svg'
  orange: require '@keboola/indigo-ui/lib/img/status-orange.svg'
  red: require '@keboola/indigo-ui/lib/img/status-red.svg'
