...
import { createConfiguration, parseConfiguration, isComplete } from './targetProject';
...
describe('credentials', function() {
  ...
  describe('isComplete()', function() {
    ...
    it('should return true when parameters are filled', function() {
      assert.equal(isComplete(Immutable.fromJS({parameters: {'url': 'a', '#token': 'b', 'bucket': 'c'}})), true);
    });
  });
});
