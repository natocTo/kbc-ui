...
- Name the configuration, e.g., *My database extractor*, and click on **Create Configuration**.
...
`,
      ...
      'markdown': 'Now you will configure the new extractor configuration. Start by providing a password and other credentials to access the source database where the data is stored.'
                + `
...
- Save the credentials by clickin on **Save** in the upper right corner.
`,
...
- Paste this simple query: \`SELECT * FROM population;\`
- Click on **Create Query**.
...
`,
...

    {
      ...
      'markdown': 'Now click on **<i class="fa fa-play"></i> Run Extraction** to load the data from the two external database tables into the new tables in your project. You will find them in **Storage**.',
      'media': '',
      'mediaType': '',
